...
sub_80539B0:
    push {r1}
    ldr r1, [pc, #0x80539c0-0x80539b2-2] // =dword_200A600
    ldr r1, [r1]
    mov r0, #7
    and r0, r1
    pop {r1}
    mov pc, lr
    .byte 0, 0
off_80539C0:    .word dword_200A600
// end of function sub_80539B0
...
sub_80539C4:
    ...
    strb r0, [r5,#0xf]
    str r0, [r5,#0x7c]
    ldr r0, [pc, #0x80539e4-0x80539ce-2] // =unk_200D920
    ldr r1, [pc, #0x80539e8-0x80539d0-4] // =0xF00
    bl f900_8000950
    ldr r0, [pc, #0x80539f0-0x80539d6-2] // =unk_200E820
    bl f900_8000950
    ldr r0, [pc, #0x80539ec-0x80539dc-4] // =0x6015700
    bl f900_8000950
    pop {pc}
off_80539E4:    .word unk_200D920
off_80539E8:    .word 0xF00
dword_80539EC:    .word 0x6015700
off_80539F0:    .word unk_200E820
// end of function sub_80539C4
...
loc_8053A36:
    ...
    mov r2, #0x34 // (byte_200A6F4 - 0x200a6c0)
    strb r0, [r1,r2]
    pop {r0-r2}
    lsl r1, r1, #1
    ldrh r1, [r0,r1]
...
sub_8053A6C:
    ...
    mov r1, #8
    mul r0, r1
    ldr r6, [pc, #0x8053aec-0x8053a8a-2] // =unk_8053AF0
    add r6, r6, r0
...
off_8053AEC:    .word unk_8053AF0
unk_8053AF0:    .byte 0xB8
    .byte 0xE2
    .balign 4, 0x00
...
sub_8053B84:
    ...
    lsl r4, r4, #3
    strb r4, [r1]
    strb r5, [r1,#0x3] // (byte_200A6C3 - 0x200a6c0)
    str r6, [r1,#0x14] // (dword_200A6D4 - 0x200a6c0)
    mov r6, #0
    strb r6, [r1,#0x1] // (byte_200A6C1 - 0x200a6c0)
    str r6, [r1,#0x18] // (dword_200A6D8 - 0x200a6c0)
    str r2, [r1,#0x1c] // (dword_200A6DC - 0x200a6c0)
    str r7, [r1,#0x20] // (dword_200A6E0 - 0x200a6c0)
    add r6, r0, #0
    push {r3}
    add r0, r2, #0
    lsl r5, r5, #4
...
sub_8053BF8:
    ...
    ldr r6, [r5,#0x18] // (dword_200A6D8 - 0x200a6c0)
    lsr r7, r6, #5
    lsl r7, r7, #2
    ldr r4, [r5,#0x1c] // (dword_200A6DC - 0x200a6c0)
    add r7, r7, r4
    mov r8, r7
    mov r4, #0x1f
    and r6, r4
    mov r9, r6
    ldr r0, [r5,#0x14] // (dword_200A6D4 - 0x200a6c0)
    mov r7, #0x60 
    mul r7, r1
    add r7, r7, r0
    ldr r4, [pc, #0x8053c98-0x8053c1e-2] // =off_8053C9C
    mov r3, #0x34 // (byte_200A6F4 - 0x200a6c0)
    ldrb r6, [r5,r3]
    lsl r6, r6, #2
    ldr r4, [r4,r6]
    lsl r1, r1, #2
    ldr r3, [r4,r1]
    lsl r3, r3, #2
    ldr r4, [r5,#0x18] // (dword_200A6D8 - 0x200a6c0)
    add r4, r4, r3
    str r4, [r5,#0x18] // (dword_200A6D8 - 0x200a6c0)
    mov r2, #0x40 
    sub r2, r3, r2
    neg r2, r2
    mov r10, r2
...
sub_8053CA4:
    ...
    ldrb r1, [r7,#0x3] // (byte_200A6C3 - 0x200a6c0)
    str r1, [sp,#4]
    ldrb r1, [r7]
    lsr r3, r1, #3
    mov r9, r3
    lsl r2, r1, #1
    ldr r6, [r7,#0x1c] // (dword_200A6DC - 0x200a6c0)
    ldr r7, [r7,#0x20] // (dword_200A6E0 - 0x200a6c0)
    mov r5, #0
    mov r12, r5
    str r6, [sp]
loc_8053CC4:
...
loc_8053D1C:
    ...
    add r1, r0, #0
    ldr r0, [r6,#0x20] // (dword_200A6E0 - 0x200a6c0)
    add r2, r0, #0
    sub r2, r7, r2
    bl loc_8000874
    pop {pc}
...
sub_8053D62:
    ...
    ldr r6, [r2,#0x18] // (dword_200A6D8 - 0x200a6c0)
    lsr r7, r6, #5
    lsl r7, r7, #2
    ldr r4, [r2,#0x1c] // (dword_200A6DC - 0x200a6c0)
    add r7, r7, r4
    mov r4, #0x1f
    and r6, r4
...
loc_8053D8A:
    ...
    sub r3, #1
    bge loc_8053D80
    ldrb r4, [r2,#0x1] // (byte_200A6C1 - 0x200a6c0)
    add r4, #1
    strb r4, [r2,#0x1] // (byte_200A6C1 - 0x200a6c0)
    ldrb r1, [r2]
    mov r7, #0xe
    mul r1, r7
    lsl r1, r1, #3
    mul r1, r4
    str r1, [r2,#0x18] // (dword_200A6D8 - 0x200a6c0)
    pop {r0}
    add r0, #1
    mov pc, lr
    .word byte_200A6C0
...
off_8053E94:    .word sub_8102E9C+1
    .word sub_8103ED0+1
    .word sub_81045E0+1
    .word sub_81048C0+1
    .word sub_8104C58+1
