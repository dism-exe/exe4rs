...
loc_804762C:
    ...
    lsl r0, r5, #3
    add r7, r7, r0
    ldr r6, [pc, #0x8047660-0x8047632-2] // =dword_8047664
    mov r4, #0
loc_8047636:
    ldrb r2, [r1,r4]
    ldrb r3, [r7,r4]
...
off_8047660:    .word dword_8047664
dword_8047664:    .word 0x12180411, 0xF1B09, 0xB081015, 0x19011613, 0xA030C1A
    .word 0x1C06020D, 0x50E1417, 0x1D07
...
sub_8047768:
    ...
    ldr r1, [r1,#4]
    ldrh r0, [r1]
    strh r0, [r5,#0x8] // (word_2009E58 - 0x2009e50)
    ldrh r0, [r1,#2]
    strh r0, [r5,#0xa] // (word_2009E5A - 0x2009e50)
    ldrh r0, [r1,#4]
    strh r0, [r5,#0xc] // (word_2009E5C - 0x2009e50)
    mov r0, #0
    strh r0, [r1]
    strh r0, [r1,#2]
    strh r0, [r1,#4]
    ...
    mov r1, r10
    ldr r1, [r1,#4]
    ldrh r0, [r5,#0x8] // (word_2009E58 - 0x2009e50)
    strh r0, [r1]
    ldrh r0, [r5,#0xa] // (word_2009E5A - 0x2009e50)
    strh r0, [r1,#2]
    ldrh r0, [r5,#0xc] // (word_2009E5C - 0x2009e50)
    strh r0, [r1,#4]
    pop {r1-r3}
    mov r8, r1
    mov r9, r2
...
sub_80480A4:
    ...
    str r0, [r7,#0x1c] // (dword_200A3EC - 0x200a3d0)
    strh r1, [r7,#0xa] // (word_200A3DA - 0x200a3d0)
    strh r2, [r7,#0xe] // (word_200A3DE - 0x200a3d0)
    pop {r4-r7,pc}
...
sub_80480B4:
    ...
    str r0, [r7,#0x20] // (dword_200A3F0 - 0x200a3d0)
    str r0, [r7,#0x24] // (dword_200A3F4 - 0x200a3d0)
    strb r2, [r7,#0x3] // (byte_200A3D3 - 0x200a3d0)
    strb r3, [r7,#0x2] // (byte_200A3D2 - 0x200a3d0)
    ldr r0, [pc, #0x80480fc-0x80480c0-4] // =dword_8048040+20
    lsl r1, r1, #4
    add r0, r0, r1
    ldr r1, [r0]
    str r1, [r7,#0x34] // (dword_200A404 - 0x200a3d0)
    ldr r1, [r0,#4]
    str r1, [r7,#0x38] // (dword_200A408 - 0x200a3d0)
    ldr r1, [r0,#8]
    str r1, [r7,#0x3c] // (dword_200A40C - 0x200a3d0)
    ldrb r1, [r0,#0xc]
    strb r1, [r7]
    strb r1, [r7,#0x1] // (byte_200A3D1 - 0x200a3d0)
    mov r1, #0
    strb r1, [r7,#0x5] // (byte_200A3D5 - 0x200a3d0)
    strb r1, [r7,#0x8] // (byte_200A3D8 - 0x200a3d0)
    strh r1, [r7,#0x18] // (word_200A3E8 - 0x200a3d0)
    mvn r1, r1
    strh r1, [r7,#0x10] // (word_200A3E0 - 0x200a3d0)
    strh r1, [r7,#0x12] // (word_200A3E2 - 0x200a3d0)
    strh r1, [r7,#0x14] // (word_200A3E4 - 0x200a3d0)
    strh r1, [r7,#0x16] // (word_200A3E6 - 0x200a3d0)
    pop {r4-r7,pc}
...
sub_80480EC:
    ...
    ldr r0, [r7,#0x48] // (dword_200A416+2 - 0x200a3d0)
    mov r1, #3
    and r0, r1
...
sub_8048120:
    ...
    mov r0, #8
    strb r0, [r7]
    strb r0, [r7,#0x1] // (byte_200A3D1 - 0x200a3d0)
    mov r0, #0x10
    strh r0, [r7,#0xc] // (word_200A3DC - 0x200a3d0)
    mov r0, #0
    strb r0, [r7,#0x8] // (byte_200A3D8 - 0x200a3d0)
    pop {r7,pc}
...
sub_804814C:
    ...
    ldrh r0, [r7,#0xe] // (word_200A3DE - 0x200a3d0)
    cmp r0, #2
    blt loc_804815A
    mov r1, #0
loc_804815A:
...
sub_8048164:
    ...
    ldrb r0, [r7,#0x1] // (byte_200A3D1 - 0x200a3d0)
    cmp r0, #8
    bne loc_8048192
    ldrb r0, [r7]
    cmp r0, #8
    ...
    and r1, r0
    beq loc_804818A
    ldrh r0, [r7,#0xc] // (word_200A3DC - 0x200a3d0)
    cmp r0, #8
    blt loc_8048190
    b loc_8048192
loc_804818A:
...
sub_80481EC:
    ...
    bl sub_8110C04
    str r0, [r7,#0x48] // (dword_200A416+2 - 0x200a3d0)
    sub sp, sp, #0x10
    str r0, [sp]
    bl sub_8111674
    cmp r0, #1
...
loc_8048220:
    mov r1, #1
    strb r1, [r7,#0x6] // (byte_200A3D6 - 0x200a3d0)
    b loc_804823E
loc_8048226:
    cmp r0, #2
    bne loc_804823E
    ldrb r2, [r7,#0x7] // (byte_200A3D7 - 0x200a3d0)
    cmp r2, #2
    bne loc_8048236
    mov r0, #0xff
    strb r0, [r7,#0x7] // (byte_200A3D7 - 0x200a3d0)
    b loc_804823E
loc_8048236:
    strb r0, [r7,#0x7] // (byte_200A3D7 - 0x200a3d0)
    mov r1, #1
...
loc_804823E:
    ...
    lsr r0, r0, #2
    str r0, [sp,#8]
    strb r0, [r7,#0x4] // (byte_200A3D4 - 0x200a3d0)
    ldr r0, [sp]
    mov r1, #0x20 
    and r0, r1
    beq loc_80482A6
...
loc_80482AE:
    ...
    ldrb r1, [r0,#0x5] // (byte_200A3D5 - 0x200a3d0)
    tst r1, r1
    beq loc_80482BE
    mov r6, #4
loc_80482BE:
...
sub_8048444:
    ...
    mov r0, #1
    strb r0, [r6,#0x5] // (byte_200A3D5 - 0x200a3d0)
    ldr r1, [pc, #0x804845c-0x804844e-2] // =jt_8048460
    ldrb r0, [r6,#0x1] // (byte_200A3D1 - 0x200a3d0)
    ldr r0, [r1,r0]
    mov lr, pc
    bx r0
    pop {r4-r7,pc}
...
sub_8048660:
    ...
    ldrh r2, [r7,#0x10] // (word_200A3E0 - 0x200a3d0)
    ldrh r0, [r7,#0x16] // (word_200A3E6 - 0x200a3d0)
    mov r1, #0
    b locret_8048684
loc_8048680:
    mov r1, #1
...
loc_8048706:
    add r0, #8
    str r0, [r7,#0x54] // (dword_200A424 - 0x200a3d0)
    mov r0, #0xc
    strb r0, [r7]
locret_804870E:
    pop {r0-r2,r7,pc}
...
loc_804872E:
    add r0, #8
    ldr r1, [r7,#0x54] // (dword_200A424 - 0x200a3d0)
    cmp r0, r1
    bge loc_8048738
    add r0, r1, #0
loc_8048738:
...
sub_8048878:
    push {lr}
    ldr r0, [pc, #0x80488dc-0x804887a-2] // =byte_80488E0
    mov r1, r10
    ldr r1, [r1,#0x44]
    add r1, #0x54 
    mov r2, #0x14
...
sub_80488BC:
    push {r4-r7,lr}
    ldr r0, [pc, #0x80488dc-0x80488be-2] // =byte_80488E0
    mov r1, r10
    ldr r1, [r1,#0x44]
    add r1, #0x54 
    mov r2, #0x13
...
loc_80488D8:
    mov r0, #1
    pop {r4-r7,pc}
off_80488DC:    .word byte_80488E0
byte_80488E0:    .byte 0x52
    .byte 0x4F 
    .byte 0x43 
    .byte 0x4B 
    .byte 0x4D 
...
sub_80488F8:
    ...
    mov r1, #0x88
    bl sub_8024FB8
    ldr r0, [pc, #0x80489dc-0x8048902-2] // =byte_80488E0
...
loc_804895A:
    ...
    blt loc_804895A
loc_804897C:
    ldr r0, [pc, #0x80489dc-0x804897c-4] // =byte_80488E0
...
sub_8049010:
    ...
    strb r0, [r5,#0x4] // (byte_200A724 - 0x200a720)
    ldr r2, [pc, #0x8049038-0x8049022-2] // =off_8048F08
    mov r1, #0x24 
    mul r0, r1
    add r0, r0, r2
    str r0, [r5,#0x1c] // (dword_200A73C - 0x200a720)
    mov r2, r10
    ldr r2, [r2,#0x40]
    ldrh r0, [r2,#4]
    strh r0, [r2,#0xc]
...
sub_8049688:
    ...
    mov r1, #0x40 
    bl f900_8000910
    ldr r3, [pc, #0x8049838-0x8049692-2] // =unk_804983C
    mov r6, r10
    ldr r6, [r6,#0x24]
    ldrh r6, [r6]
    mov r7, #0x1f
...
loc_80496AE:
    ...
    and r3, r7
    lsl r3, r3, #2
    ldr r0, [pc, #0x8049708-0x80496cc-4] // =unk_8049710
    ldr r0, [r0,r3]
    mov r2, #8
    mul r2, r6
    ...
    str r0, [r1,r2]
    add r2, #4
    ldr r0, [pc, #0x804970c-0x80496da-2] // =unk_8049790
    ldr r0, [r0,r3]
    str r0, [r1,r2]
    pop {r4-r7}
loc_80496E2:
...
off_8049708:    .word unk_8049710
off_804970C:    .word unk_8049790
unk_8049710:    .byte 0x30 
    .byte 0x52 
    .byte 0x31 
    .byte 0x52 
    .byte 0x30 
...
sub_8049810:
    push {r4-r7,lr}
    ldr r3, [pc, #0x8049838-0x8049812-2] // =unk_804983C
    mov r6, r10
    ldr r6, [r6,#0x24]
    ldrh r6, [r6]
    mov r7, #0x1f
...
off_8049838:    .word unk_804983C
unk_804983C:    .byte 0x12
    .byte 0xCC
    .byte 0x12
    .byte 0xCC
    .byte 0x12
...
sub_8049CB0:
    ...
    strb r0, [r5,#0x4] // (byte_200A744 - 0x200a740)
    ldr r2, [pc, #0x8049cdc-0x8049cc2-2] // =dword_8049BA0
    mov r1, #0x10
    mul r0, r1
    add r0, r0, r2
    str r0, [r5,#0x1c] // (dword_200A75C - 0x200a740)
    ldr r0, [pc, #0x8049ce0-0x8049ccc-4] // =unk_2026000
    str r0, [r5,#0x24] // (dword_200A764 - 0x200a740)
    mov r1, r10
    ldr r1, [r1,#0x40]
    ldrh r0, [r1,#4]
    strh r0, [r1,#0xc]
...
sub_804A1F0:
    ...
    bl dword_8111700
    ldr r7, [pc, #0x804a224-0x804a1fc-4] // =dword_86E4BEC
    mov r0, r10
    ldr r0, [r0,#0x40]
    ldrb r0, [r0,#4]
    cmp r0, #0x80
...
off_804A224:    .word dword_86E4BEC
...
sub_804A230:
    push {r4-r7,lr}
    ldr r3, [pc, #0x804a264-0x804a232-2] // =byte_804A268
    lsl r4, r2, #1
    lsl r0, r0, #0x10
    orr r0, r1
    mov r6, r10
...
off_804A264:    .word byte_804A268
byte_804A268:    .byte 0xF, 0xE0, 0xF, 0xE0, 0xF
    .byte 0xE0, 0xF, 0xE0, 0xF, 0xE0
    .byte 0xF, 0xE0, 0xF, 0xE0, 0xF
    .byte 0xE0, 0xF, 0xE0, 0xF, 0xE0
    .byte 0xF, 0xE0, 0xF, 0xE0, 0xF
    .byte 0xE0, 0xF, 0xE0, 0xF, 0xE0
    .byte 0xF, 0xE0, 0xF, 0xE0, 0xF
    .byte 0xE0, 0xF, 0xE0, 0xF, 0xE0
    .byte 0xE, 0xE0, 0xE, 0xE0, 0xE
    .byte 0xE0, 0xE, 0xE0, 0xE, 0xE0
    .byte 0xE, 0xE0, 0xE, 0xE0, 0xE
    .byte 0xE0, 0xE, 0xE0, 0xE, 0xE0
    .byte 0xE, 0xE0, 0xE, 0xE0, 0x11
    .byte 0xE0, 0x11, 0xE0, 0x11, 0xE0
    .byte 0x11, 0xE0, 0x11, 0xE0, 0x11
    .byte 0xE0, 0x11, 0xE0, 0x11, 0xE0
    .byte 0x11, 0xE0, 0x11, 0xE0, 0x11
    .byte 0xE0, 0x11, 0xE0, 0x11, 0xE0
    .byte 0x11, 0xE0, 0x11, 0xE0, 0x11
    .byte 0xE0, 0x11, 0xE0, 0x11, 0xE0
    .byte 0x11, 0xE0, 0x11, 0xE0, 0x10
    .byte 0xE0, 0x10, 0xE0, 0x10, 0xE0
    .byte 0x10, 0xE0, 0x10, 0xE0, 0x10
    .byte 0xE0, 0x10, 0xE0, 0x10, 0xE0
    .byte 0x10, 0xE0, 0x10, 0xE0, 0x10
    .byte 0xE0, 0x10, 0xE0
...
loc_804A368:
    ...
    mov r1, #0
    strh r1, [r0,#0x12] // (word_200A752 - 0x200a740)
    mov r0, #1
    strh r0, [r5,#0xe]
    mov r0, #1
    b loc_804A38C
...
sub_804A5EC:
    ...
    mul r4, r0
    push {r4,r5}
    ldr r0, [pc, #0x804a628-0x804a5f6-2] // =unk_87548F4
...
// end of function sub_804A5EC
    ...
    ldr r0, [r5,#0x24]
    mov r1, #0x10
    ldr r2, [pc, #0x804a634-0x804a612-2] // =unk_2014200
    ldr r3, [pc, #0x804a638-0x804a614-4] // =0x6008600
    add r2, r2, r4
    add r3, r3, r4
    mov r4, #1
    mov r5, #1
    ldr r6, [pc, #0x804a63c-0x804a61e-2] // =dword_86C6E60
    mov r7, #0
    bl sub_8053A04
    pop {r0,r5,r7,pc}
off_804A628:    .word unk_87548F4
off_804A62C:    .word word_2014000
dword_804A630:    .word 0x6008400
off_804A634:    .word unk_2014200
dword_804A638:    .word 0x6008600
...
loc_804A676:
    ...
    bne loc_804A6A2
    push {r1-r3}
    ldr r2, [pc, #0x804a6e0-0x804a682-2] // =0x16C0
    add r1, r1, r2
    add r0, r1, #0
    bl sub_8024FF4
    pop {r1-r3}
    bne loc_804A6A2
    push {r1-r3}
    ldr r2, [pc, #0x804a7d8-0x804a692-2] // =0x1CC0
    add r1, r1, r2
    add r0, r1, #0
    bl sub_8024FF4
    pop {r1-r3}
    ...
    mov r3, #0x1b
loc_804A6A2:
    ldr r0, [pc, #0x804a6d0-0x804a6a2-2] // =byte_8746D20
    add r1, r3, #0
    ldr r2, [pc, #0x804a6d4-0x804a6a6-2] // =unk_2014200
    ldr r3, [pc, #0x804a6d8-0x804a6a8-4] // =0x6008600
    add r2, r2, r4
    add r3, r3, r4
    mov r4, #1
    mov r5, #1
    ldr r6, [pc, #0x804a6dc-0x804a6b2-2] // =dword_86C6E60
    mov r7, #0
    bl sub_8053A04
    pop {r0,r5,r7,pc}
...
off_804A6D0:    .word byte_8746D20
off_804A6D4:    .word unk_2014200
dword_804A6D8:    .word 0x6008600
off_804A6DC:    .word dword_86C6E60
off_804A6E0:    .word 0x16C0
.thumb
sub_804A6E4:
    push {r0,r5,r7,lr}
    mov r4, #0x40 
...
// end of function sub_804A6E4
    ...
    ldr r0, [r5,#0x24]
    mov r1, #0x10
    ldr r2, [pc, #0x804a730-0x804a70c-4] // =unk_2014200
    ldr r3, [pc, #0x804a734-0x804a70e-2] // =0x6008600
    add r2, r2, r4
    add r3, r3, r4
    mov r4, #1
    mov r5, #1
    ldr r6, [pc, #0x804a738-0x804a718-4] // =dword_86C6E60
    mov r7, #0
    bl sub_8053A04
    pop {r0,r5,r7,pc}
    .balign 4, 0x00
...
off_804A730:    .word unk_2014200
dword_804A734:    .word 0x6008600
...
loc_804A84E:
    ...
    b locret_804A88A
loc_804A86E:
    ldr r0, [pc, #0x804a890-0x804a86e-2] // =unk_86E6888
    ldrh r1, [r7,#2]
    lsr r1, r1, #2
    bl sub_804E2A4
    mov r0, #1
...
sub_804BDD4:
    ...
    str r0, [r5,#0x30] // (dword_200B1C0 - 0x200b190)
    mov r1, r10
    ldr r1, [r1,#0x40]
    ldrh r0, [r1,#4]
    strh r0, [r1,#0xc]
...
// end of function sub_804BE44
    ...
    mov r1, r10
    ldr r1, [r1,#0x44]
    mov r0, #0x5 // (loc_3006588+1 - 0x3006584)
    strb r0, [r1,#2]
...
sub_804C1F8:
    ...
    bl f900_80009A0
    ldr r0, [pc, #0x804c324-0x804c254-4] // =dword_8706F00
...
off_804C324:    .word dword_8706F00
...
sub_804C5F4:
    ...
    mov r1, r9
    bl sub_804C5BC
// end of function sub_804C5F4

    ldr r0, [pc, #0x804c62c-0x804c614-4] // =dword_201C000
    mov r2, r9
    lsl r2, r2, #2
    ldr r1, [pc, #0x804c650-0x804c61a-2] // =off_804C654
    ldr r1, [r1,r2]
    mov lr, pc
    bx r1
    pop {r2,r3}
...
sub_804D9EC:
    ...
    bl sub_804DCDC
    str r0, [r5,#0x4c] // (dword_200B1DC - 0x200b190)
    str r1, [r5,#0x50] // (dword_200B1E0 - 0x200b190)
    ...
    bne loc_804DA12
loc_804DA04:
    ldr r0, [r5,#0x4c] // (dword_200B1DC - 0x200b190)
    add r1, r5, #0
    add r1, #0x34 
    bl sub_804DAA0
    tst r0, r0
...
loc_804DA12:
    ...
    beq loc_804DA04
loc_804DA20:
    ldr r0, [r5,#0x50] // (dword_200B1E0 - 0x200b190)
    mov r1, #5
    bl sub_804DA68
    add r2, r0, #0
    lsl r0, r0, #2
    ...
    pop {r0,r1}
    beq loc_804DA54
    ldr r2, [r5,#0x4c] // (dword_200B1DC - 0x200b190)
    bl sub_804DC04
    b locret_804DA5A
loc_804DA54:
    ldr r0, [r5,#0x4c] // (dword_200B1DC - 0x200b190)
...
sub_804DFA0:
    push {r4,r5,lr}
    bl sub_804E2A4
    ldr r0, [pc, #0x804dfb8-0x804dfa6-2] // =dword_804DFBC
    mov r1, r10
    ldr r1, [r1,#0x2c]
    add r1, #0x68 
    mov r2, #8
    ...
    pop {r4,r5,pc}
    .balign 4, 0x00
off_804DFB8:    .word dword_804DFBC
dword_804DFBC:    .word 0x7F007C, 0x7E007D
...
loc_804E0DE:
    ...
    sub r1, #0xe5
    lsl r1, r1, #2
    ldr r2, [pc, #0x804e154-0x804e0ee-2] // =dword_804E864
    ldr r1, [r2,r1]
    mov lr, pc
    bx r1
    b loc_804E0DE
...
off_804E154:    .word dword_804E864
    .word 0x804E15C
...
sub_804E1A8:
    ...
    mov r7, #0x8 // (dword_804E234 - 0x804e22c)
loc_804E1CE:
    mov r0, #5
loc_804E1D0:
    push {r0}
...
sub_804E2A4:
    ...
    mov r2, #0x90
    str r0, [r5,r2]
    ldr r0, [pc, #0x804e374-0x804e348-4] // =dword_8753894
...
loc_804E366:
    ...
    pop {r4-r6,pc}
    .balign 4, 0x00
off_804E374:    .word dword_8753894
...
off_804E7F8:    .word sub_804E8D0+1
    ...
    .word sub_8050ADC+1
    .word sub_80514B8+1
dword_804E864:    .word 0x804E929, 0x804E9BD, 0x804EADD, 0x804EB11, 0x804EBF5
...
loc_804EE9A:
    ...
    mov r0, #0
    pop {pc}
// end of function function_chunk_804EE64
...
loc_804F634:
    ldrb r0, [r4,#1]
    ldr r1, [pc, #0x804f640-0x804f636-2] // =unk_804F644
    ldrb r0, [r1,r0]
    add r4, r4, r0
    pop {pc}
    .byte 0, 0
off_804F640:    .word unk_804F644
unk_804F644:    .byte 4
    .byte 4
    .byte 4
    .byte 7
// end of function sub_804F604
...
sub_804FB78:
    ...
    ldrb r2, [r4,#3]
    add r1, r1, r2
    ldr r0, [pc, #0x804fd98-0x804fb96-2] // =byte_86E82DC
    lsl r1, r1, #1
    ldrh r1, [r0,r1]
    add r0, r0, r1
    add r7, r5, #0
...
loc_804FC22:
    ...
    ldr r1, [r2]
    add r1, r1, r7
    ldr r0, [pc, #0x804fd98-0x804fc3e-2] // =byte_86E82DC
    lsl r1, r1, #1
    ldrh r1, [r0,r1]
    add r0, r0, r1
    add r7, r5, #0
...
loc_804FCC2:
    ...
    ldr r1, [r2]
    add r1, r1, r7
    ldr r0, [pc, #0x804fd98-0x804fcde-2] // =byte_86E82DC
    lsl r1, r1, #1
    ldrh r1, [r0,r1]
    add r0, r0, r1
    add r7, r5, #0
...
sub_804FD1C:
    ...
    ldr r1, [r2]
    add r1, r1, r7
    ldr r0, [pc, #0x804fd98-0x804fd5a-2] // =byte_86E82DC
    lsl r1, r1, #1
    ldrh r1, [r0,r1]
    add r0, r0, r1
    add r7, r5, #0
...
loc_8050794:
    sub r0, #0x20 
    ldr r1, [pc, #0x80507a0-0x8050796-2] // =unk_80507A4
    ldrb r0, [r1,r0]
    add r4, r4, r0
    pop {pc}
    .byte 0, 0
off_80507A0:    .word unk_80507A4
unk_80507A4:    .byte 7
    .byte 7
    .byte 4
    .byte 7
...
loc_8050940:
    sub r0, #0x40 
    ldr r1, [pc, #0x805094c-0x8050942-2] // =unk_8050950
    ldrb r0, [r1,r0]
    add r4, r4, r0
    pop {pc}
    .balign 4, 0x00
off_805094C:    .word unk_8050950
unk_8050950:    .byte 5
    .byte 5
    .byte 5
    .byte 8
...
loc_8050A34:
    sub r0, #0x12
    ldr r1, [pc, #0x8050a40-0x8050a36-2] // =unk_8050A44
    ldrb r0, [r1,r0]
    add r4, r4, r0
    pop {pc}
    .byte 0, 0
off_8050A40:    .word unk_8050A44
unk_8050A44:    .byte 9
    .byte 9
    .byte 6
    .byte 9
...
// end of function sub_8050A48
    ...
    sub r0, #0x16
    ldr r1, [pc, #0x8050ad4-0x8050aca-2] // =unk_8050AD8
    ldrb r0, [r1,r0]
    add r4, r4, r0
    pop {pc}
    .balign 4, 0x00
off_8050AD4:    .word unk_8050AD8
unk_8050AD8:    .byte 9
    .byte 9
    .byte 6
    .byte 9
...
sub_8050EA4:
    ...
    ldrh r6, [r7,#0x4] // (word_8050F18 - 0x8050f14)
    add r6, r6, r2
    add r0, r6, #0
    bl sub_8024FA0
    ldrh r6, [r7,#0x2] // (word_8050F16 - 0x8050f14)
    add r6, r6, r2
    add r0, r6, #0
    bl sub_8024FA0
    push {r7}
