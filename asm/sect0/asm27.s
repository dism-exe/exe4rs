...
loc_809EDAA:
    ...
    mov r4, #(dword_809EE2C - 0x809ee20)
loc_809EDB4:
    ldr r0, [r5,r4]
    ldr r1, [r6,r4]
    mov r2, #1
...
sub_809F388:
    ...
    ldrh r0, [r6,#(word_809F48A - 0x809f484)]
    mov r1, #4
    .hword 0x1c00 // add r0, r0, #0  // <mkdata>
    add r2, r1, #0
    bl loc_8025038
...
loc_809F3D8:
    ...
    ldrh r0, [r6,#(word_809F486 - 0x809f484)]
    mov r1, #0xc
    .hword 0x1c00 // add r0, r0, #0  // <mkdata>
    add r2, r1, #0
    bl loc_8025038
...
sub_809FF80:
    ...
    mov r0, #1
    strb r0, [r5,#(byte_20004D8 - 0x20004d0)]
    mov r0, #0xc6
    strb r0, [r5,#(byte_20004DC - 0x20004d0)]
    mov r0, #0x14
    neg r0, r0
    strb r0, [r5,#(byte_20004DD - 0x20004d0)]
    mov r0, #0
    strb r0, [r5,#(word_20004DE - 0x20004d0)]
    mov r0, #0
    pop {r4-r7,pc}
...
sub_809FFA6:
    ...
    ldrb r0, [r5,#(byte_20004D8 - 0x20004d0)]
    tst r0, r0
    beq loc_80A0010
    mov r0, #1
    bl sub_802D92C
    bne loc_80A0010
    ldrb r0, [r5,#(byte_20004D3 - 0x20004d0)]
    tst r0, r0
    beq loc_809FFD0
    mov r0, #0
...
loc_809FFD0:
    bl sub_8054018
    bl sub_8054054
    ldrb r0, [r5,#(word_20004DE - 0x20004d0)]
    tst r0, r0
    bne loc_809FFEC
    mov r1, #(byte_20004DD - 0x20004d0)
    ldrsb r0, [r5,r1]
    cmp r0, #0x14
    bge loc_809FFE8
    add r0, #2
...
sub_80A02C6:
    ...
    mov r0, #0
    strb r0, [r5,#(word_20004DE+1 - 0x20004d0)]
    mov r0, #0
    pop {r4-r7,pc}
...
loc_80A0306:
    ...
    bl sub_8109FDA
loc_80A0312:
    ldrb r0, [r5,#(byte_20004DD - 0x20004d0)]
    tst r0, r0
    bne loc_80A03BE
    bl sub_80A0466
    bne loc_80A039A
    mov r0, #0xa
    strb r0, [r5,#(byte_20004DB - 0x20004d0)]
    ldrb r0, [r5,#(byte_20004DC - 0x20004d0)]
    sub r0, #1
    strb r0, [r5,#(byte_20004DC - 0x20004d0)]
    bgt loc_80A03BE
    mov r0, #0
...
loc_80A0346:
    ...
    b loc_80A03BE
loc_80A034C:
    ldrb r4, [r5,#(word_20004DE - 0x20004d0)]
    tst r4, r4
    bne loc_80A036E
    bl sub_80A0454
    bne loc_80A036E
...
loc_80A039A:
    ...
    mov r0, #0x3c 
    strb r0, [r5,#(byte_20004DC - 0x20004d0)]
    ldrb r0, [r5,#(byte_20004DB - 0x20004d0)]
    sub r0, #1
    strb r0, [r5,#(byte_20004DB - 0x20004d0)]
    bgt loc_80A03BE
    mov r1, r10
...
sub_80A05C8:
    ...
    ldrb r0, [r0,#(byte_200A620 - 0x200a610)]
    strb r0, [r5,#7]
    mov r0, #0x1d
    bl sub_80A6DB8
    b loc_80A0634
loc_80A05E2:
    ...
    ldrb r1, [r0,#(byte_200A620 - 0x200a610)]
    strb r1, [r5,#7]
    ...
    ldr r2, [r3,#4]
    sub r2, r2, r4
    ldr r3, [r0,#(dword_200A634 - 0x200a610)]
    sub r3, r3, r1
    add r5, r3, #0
    cmp r5, #0
    bge loc_80A060A
    neg r5, r5
loc_80A060A:
    ldr r4, [r0,#(dword_200A638 - 0x200a610)]
    sub r4, r4, r2
    add r6, r4, #0
    cmp r6, #0
    bge loc_80A0616
...
loc_80A0708:
    ...
    mov r4, #(dword_80A07DC - 0x80a07d0)
loc_80A071A:
    ldr r0, [r5,r4]
    ldr r1, [r6,r4]
    mov r2, #1
...
loc_80A0D40:
    ...
    ldr r0, [r7,#0x2c]
    ldr r1, [r3,#(dword_200A63C - 0x200a610)]
    mov r5, #5
    lsl r5, r5, #0x10
    sub r1, r1, r0
    cmp r1, #0
...
loc_80A0D56:
    ...
    bgt loc_80A0E3C
    ldr r0, [r7,#0x24]
    ldr r1, [r3,#(dword_200A634 - 0x200a610)]
    sub r0, r0, r1
    cmp r0, #0
    bge loc_80A0D66
    neg r0, r0
loc_80A0D66:
    ...
    mul r0, r1
    ldr r1, [r7,#0x28]
    ldr r2, [r3,#(dword_200A638 - 0x200a610)]
    sub r1, r1, r2
    cmp r1, #0
    bge loc_80A0D78
    neg r1, r1
...
loc_80A0DC0:
    ...
    tst r6, r6
    beq loc_80A0DF6
    ldr r4, [r3,#(dword_200A638 - 0x200a610)]
    ldr r0, [r7,#0x28]
    sub r4, r4, r0
    ldr r1, [r3,#(dword_200A634 - 0x200a610)]
    ldr r0, [r7,#0x24]
...
loc_80A0DEA:
    ...
    b loc_80A0E3C
loc_80A0DF6:
    ldr r4, [r3,#(dword_200A634 - 0x200a610)]
    ldr r0, [r7,#0x24]
    sub r4, r4, r0
    ldr r2, [r3,#(dword_200A638 - 0x200a610)]
    ldr r1, [r7,#0x28]
...
sub_80A1BEC:
    ...
    mov r0, #0x3c 
    strb r0, [r7,#(byte_2001E91 - 0x2001e90)]
    mov r0, #0
    pop {r4-r7,pc}
...
loc_80A1C0A:
    mov r0, #0
    strb r0, [r5,#(byte_20004D3 - 0x20004d0)]
    ldrb r0, [r7,#(byte_2001E91 - 0x2001e90)]
    sub r0, #1
    strb r0, [r7,#(byte_2001E91 - 0x2001e90)]
    bgt loc_80A1C3C
    mov r0, #0x3c 
...
loc_80A2810:
    ...
    strb r4, [r7,#(byte_2007394 - 0x2007390)]
    pop {r4-r7,pc}
    .balign 4, 0x00
...
loc_80A2976:
    ...
    mov r0, #0
    strb r0, [r1,#(byte_2007391 - 0x2007390)]
    strb r0, [r1]
    strb r0, [r1,#(byte_2007392 - 0x2007390)]
    strb r0, [r1,#(byte_2007393 - 0x2007390)]
    bl sub_80A29C8
    pop {r4-r7,pc}
...
sub_80A2990:
    ...
    mov r1, #0
    strb r1, [r5,#(byte_2007395 - 0x2007390)]
    strh r1, [r5,#(word_2007396 - 0x2007390)]
    mov r0, #0
    pop {r4-r7,pc}
...
sub_80A299E:
    ...
    ldrb r1, [r5,#(byte_2007395 - 0x2007390)]
    ldr r0, [r0,r1]
    mov lr, pc
    bx r0
    pop {r4-r7,pc}
...
sub_80A29C8:
    ...
    add r0, r0, r1
    strh r0, [r5,#(word_2007396 - 0x2007390)]
    pop {r4-r7,pc}
...
loc_80A2A3A:
    ...
    ldrsb r0, [r7,r0]
    lsl r0, r0, #0xc
    ldr r1, [r4,#(dword_200B200 - 0x200b1f0)]
    add r1, r1, r0
    str r1, [r4,#(dword_200B200 - 0x200b1f0)]
    mov r0, r10
    ldr r0, [r0,#4]
    ldrh r0, [r0,#2]
    ...
    bgt loc_80A2A70
    mov r0, #0
    str r0, [r4,#(dword_200B200 - 0x200b1f0)]
    b loc_80A2A70
loc_80A2A70:
    ldr r1, [r4,#(dword_200B200 - 0x200b1f0)]
    cmp r1, #0
...
loc_80A2A7C:
    mov r1, #0x46 
    lsl r1, r1, #0x10
    ldr r2, [r4,#(dword_200B200 - 0x200b1f0)]
    cmp r1, r2
    bge loc_80A2AAA
    mov r0, #0x3c 
    bl sub_80A6DB8
...
loc_80A2A96:
    ...
    mov r0, #1
    strb r0, [r1,#(dword_200AACC - 0x200aac0)]
    mov r0, #0x3c 
    bl sub_80A6DB8
    mov r0, #0x3c 
    strh r0, [r5,#6]
...
loc_80A2ACC:
    ...
    ldrb r0, [r1,#(dword_200AACC - 0x200aac0)]
    cmp r0, #2
    bne loc_80A2AE8
    ldrh r0, [r5,#6]
    sub r0, #1
...
sub_80A2BB0:
    ...
    strb r0, [r1,#0xb]
    mov r0, #0x24 
    strb r0, [r5,#(byte_20004E1 - 0x20004d0)]
    mov r0, #0
    pop {r4-r7,pc}
...
sub_80A2BF4:
    ...
    mov r0, #0
    strb r0, [r5,#(byte_20004D9 - 0x20004d0)]
    mov r0, #0x24 
    neg r0, r0
    strb r0, [r5,#(byte_20004E1 - 0x20004d0)]
    mov r0, #0
...
sub_80A2C12:
    ...
    strh r0, [r5,#(word_20004DE - 0x20004d0)]
    mov r0, #0
    pop {r4-r7,pc}
...
loc_80A2C56:
    ...
    bl sub_80A2D9C
    bne loc_80A2CCC
    ldrh r0, [r5,#(word_20004DE - 0x20004d0)]
    sub r0, #1
    strh r0, [r5,#(word_20004DE - 0x20004d0)]
    bgt loc_80A2CDC
    mov r0, #0
...
sub_80A3FBC:
    ...
    add r0, r0, r1
    strh r0, [r5,#(word_200088C - 0x2000870)]
    mov r0, #0
    pop {r4-r7,pc}
    .byte 0
    .byte 0
...
sub_80A3FE4:
    ...
    bl f900_8000930
    mov r0, #3
    strb r0, [r5,#(byte_2000878 - 0x2000870)]
    ldr r0, [pc, #0x80a4020-0x80a3ff6-2] // off_80A3DA4
    ldrb r1, [r5,#(byte_2000878 - 0x2000870)]
    lsl r1, r1, #2
    ldr r0, [r0,r1]
    mov r1, #0
    mov r2, sp
...
loc_80A4012:
    ...
    bl sub_8000C98
    add sp, sp, #0x20
    strb r0, [r5,#(byte_2000879 - 0x2000870)]
    mov r0, #0
    pop {r4-r7,pc}
...
ho_80A4034:
    ...
    ldrb r0, [r5,#(byte_2000878 - 0x2000870)]
    lsl r0, r0, #2
    ldr r4, [r4,r0]
    ldrb r0, [r5,#(byte_2000879 - 0x2000870)]
    lsl r0, r0, #3
    ldr r4, [r4,r0]
    add r7, r4, #0
    ldrh r0, [r5,#(word_2000876 - 0x2000870)]
    add r4, r4, r0
loc_80A404C:
    ...
    beq loc_80A404C
    sub r4, r4, r7
    strh r4, [r5,#(word_2000876 - 0x2000870)]
    pop {r4-r7,pc}
    .byte 0, 0
...
sub_80A41DC:
    ...
    ldr r0, [r5,#(dword_200087C - 0x2000870)]
    ldr r1, [r5,#(dword_2000880 - 0x2000870)]
    ldrb r2, [r5,#(byte_200087B - 0x2000870)]
    ldrb r3, [r5,#(byte_2000872 - 0x2000870)]
    pop {r4-r7,pc}
    .balign 4, 0x00
...
sub_80A41EC:
    ...
    ldrb r0, [r5,#(byte_2000872 - 0x2000870)]
    ldrb r1, [r5,#(byte_200087B - 0x2000870)]
    pop {r4-r7,pc}
    .balign 4, 0x00
...
sub_80A41F8:
    ...
    mov r0, #1
    strb r0, [r5,#(byte_200087B - 0x2000870)]
    pop {r4-r7,pc}
    .balign 4, 0x00
...
loc_80A4214:
    ...
    strb r0, [r5,#(byte_20004D3 - 0x20004d0)]
    bl sub_80540BA
    ldrh r0, [r7,#(word_200088E - 0x2000870)]
    tst r0, r0
    beq loc_80A423E
    mov r0, #0x38 
    mov r1, #0
...
loc_80A423E:
    ...
    bl sub_80A42FA
    beq loc_80A427E
    ldrh r0, [r7,#(word_200088C - 0x2000870)]
    sub r0, #1
    blt loc_80A425A
    strh r0, [r7,#(word_200088C - 0x2000870)]
    mov r0, #0
    strh r0, [r7,#(word_200088E - 0x2000870)]
    b loc_80A427E
loc_80A425A:
    ldrh r0, [r7,#(word_200088E - 0x2000870)]
    tst r0, r0
...
sub_80A4D20:
    ...
    ldrb r1, [r5,#(byte_200AA12 - 0x200aa10)]
    cmp r0, r1
    pop {r4-r7,pc}
...
dead_ho_80A4D2A:
    ...
    strb r0, [r5,#(byte_200AA12 - 0x200aa10)]
...
sub_80A52F2:
    ...
    add r0, #3
    ldrb r0, [r5,r0]
    strb r0, [r5,#(byte_20014E2 - 0x20014e0)]
    sub sp, sp, #0x40
    mov r0, sp
    mov r1, #0x40 
    mov r2, #0x40 
...
sub_80A53A8:
    ...
    ldrb r0, [r5,#(byte_200AB23 - 0x200ab20)]
    add r0, #1
    strb r0, [r5,#(byte_200AB23 - 0x200ab20)]
    mov r1, #0x1f
    and r1, r0
    bne loc_80A53C8
    mov r0, #0xf0
...
loc_80A5CBE:
    ...
    blt loc_80A5CFC
    bl sub_8002D60
    ldrb r0, [r7,#(byte_2000892 - 0x2000890)]
    ldrb r1, [r7]
    ldrb r2, [r7,#(byte_2000891 - 0x2000890)]
    cmp r0, #0
    bne loc_80A5CE2
    cmp r1, #0x40 
    bne loc_80A5CE2
...
loc_80A5CE8:
    bl sub_8002D9E
loc_80A5CEC:
    ldrh r0, [r7,#(word_2000896 - 0x2000890)]
    cmp r0, #0
    bne loc_80A5CF8
    bl sub_8002F1A
    b loc_80A5CFC
...
sub_80A5E84:
    ...
    ldrb r4, [r4,#(byte_2000894 - 0x2000890)]
    tst r4, r4
    beq loc_80A5EA4
loc_80A5EA4:
    strb r0, [r5,#0x14]
...
sub_80A5FE4:
    ...
    cmp r0, #0x80
    blt loc_80A5FF6
    ldrb r1, [r7,#(byte_2000893 - 0x2000890)]
loc_80A5FF6:
    ldrb r0, [r5,#0x10]
    ldr r7, [pc, #0x80a6020-0x80a5ff8-4] // off_80A6024
    ldr r7, [r7,r1]
    ldr r6, [pc, #0x80a6328-0x80a5ffc-4] // byte_200B1F0
    ldr r1, [r6,#(dword_200B208 - 0x200b1f0)]
    tst r1, r1
    beq loc_80A6006
    ldr r7, [r6,#(dword_200B210 - 0x200b1f0)]
loc_80A6006:
    lsl r1, r0, #3
    lsl r0, r0, #2
    add r0, r0, r1
...
sub_80A61A6:
    ...
    ldrb r0, [r7,#(byte_200B20C - 0x200b1f0)]
    cmp r0, #0xff
    beq loc_80A61C0
    strb r0, [r5,#0x14]
    mov r0, #0xff
    strb r0, [r7,#(byte_200B20C - 0x200b1f0)]
loc_80A61C0:
    bl sub_80A6BCC
    tst r0, r0
    beq locret_80A61DE
    mov r0, #2
    strb r0, [r7,#(byte_200B1F1 - 0x200b1f0)]
    mov r7, r10
    ldr r7, [r7,#0x40]
    mov r0, #0
    strb r0, [r7,#0x1a]
...
sub_80A6290:
    ...
    str r1, [r5,#0x34]
    str r2, [r5,#0x38]
    ldr r0, [r7,#(dword_200B1F8 - 0x200b1f0)]
    str r0, [r5,#0x24]
    ldr r0, [r7,#(dword_200B1FC - 0x200b1f0)]
    str r0, [r5,#0x28]
    ldr r0, [r7,#(dword_200B200 - 0x200b1f0)]
    str r0, [r5,#0x2c]
    ldrb r0, [r7,#(byte_200B205 - 0x200b1f0)]
    tst r0, r0
    bne loc_80A62B8
    ldrb r0, [r7,#(byte_200B1F2 - 0x200b1f0)]
    strb r0, [r5,#0x14]
    b loc_80A62C2
loc_80A62B8:
...
loc_80A62C2:
    ...
    ldrb r0, [r7,#(byte_200B1F1 - 0x200b1f0)]
    lsl r0, r0, #2
    ldr r0, [r6,r0]
    str r0, [r5,#8]
loc_80A62D4:
...
loc_80A62E2:
    ...
    ldr r0, [r5,#0x24]
    str r0, [r7,#(dword_200B1F8 - 0x200b1f0)]
    ldr r0, [r5,#0x28]
    str r0, [r7,#(dword_200B1FC - 0x200b1f0)]
    ldr r0, [r5,#0x2c]
    str r0, [r7,#(dword_200B200 - 0x200b1f0)]
    ldrb r0, [r5,#0x17]
    tst r0, r0
    beq loc_80A6302
    mov r0, #0x24 
...
loc_80A6794:
    ...
    ldrb r3, [r4,#(byte_2000894 - 0x2000890)]
    tst r3, r3
    bne loc_80A67B6
loc_80A67B4:
...
loc_80A67E2:
    ...
    ldrh r1, [r7,#(dword_200B208 - 0x200b1f0)]
    ldrh r1, [r7,#(dword_200B208+2 - 0x200b1f0)]
    mov r2, #0xf0
    and r2, r1
    beq loc_80A6824
    lsr r2, r2, #4
...
sub_80A6D46:
    ...
    ldr r1, [r1,#0x28]
    ldr r0, [r1,#0x24]
    str r0, [r3,#(dword_200B1F8 - 0x200b1f0)]
    ldr r0, [r1,#0x28]
    str r0, [r3,#(dword_200B1FC - 0x200b1f0)]
    ldr r0, [r1,#0x2c]
    str r0, [r3,#(dword_200B200 - 0x200b1f0)]
    push {r3}
    mov r0, #0x11
    mov r1, #0x7a 
    bl sub_8024FF0
...
sub_80A6D7A:
    ...
    mov r0, #1
    strb r0, [r3,#(byte_200B205 - 0x200b1f0)]
    mov r0, #0
    str r0, [r3,#(dword_200B208 - 0x200b1f0)]
    str r0, [r3,#(dword_200B210 - 0x200b1f0)]
    ldr r1, [pc, #0x80a6d8c-0x80a6d86-2] // dword_80A58E0
    str r1, [r3,#(dword_200B210 - 0x200b1f0)]
    mov pc, lr
...
sub_80A6DB8:
    ...
    strb r0, [r3,#(byte_200B1F2 - 0x200b1f0)]
    mov r0, #0x11
    mov r1, #0x7a 
    bl sub_8024F9C
    pop {pc}
...
sub_80A6DE2:
    ...
    strb r0, [r3,#(byte_200B20C - 0x200b1f0)]
    pop {pc}
    .balign 4, 0x00
...
loc_80A6E0C:
    ...
    str r0, [r3,#(dword_200B1F8 - 0x200b1f0)]
    str r1, [r3,#(dword_200B1FC - 0x200b1f0)]
    str r2, [r3,#(dword_200B200 - 0x200b1f0)]
    mov pc, lr
...
loc_80A6E46:
    ...
    ldr r3, [r7,#(dword_200B1F8 - 0x200b1f0)]
    add r3, r3, r0
    str r3, [r7,#(dword_200B1F8 - 0x200b1f0)]
    ldr r3, [r7,#(dword_200B1FC - 0x200b1f0)]
    add r3, r3, r1
    str r3, [r7,#(dword_200B1FC - 0x200b1f0)]
    ldr r3, [r7,#(dword_200B200 - 0x200b1f0)]
    add r3, r3, r2
    str r3, [r7,#(dword_200B200 - 0x200b1f0)]
    pop {r7,pc}
    .byte 0, 0
...
sub_80A6E64:
    ...
    ldrb r1, [r3,#(byte_200B205 - 0x200b1f0)]
    tst r1, r1
    beq locret_80A6E6E
    strh r0, [r3,#(dword_200B208+2 - 0x200b1f0)]
locret_80A6E6E:
    mov pc, lr
...
sub_80A6F22:
    ...
    strb r0, [r3]
    strb r1, [r3,#(byte_2000891 - 0x2000890)]
    strb r2, [r3,#(byte_2000892 - 0x2000890)]
    mov pc, lr
...
sub_80A6F32:
    ...
    ldrb r0, [r3]
    ldrb r1, [r3,#(byte_2000891 - 0x2000890)]
    ldrb r2, [r3,#(byte_2000892 - 0x2000890)]
    mov pc, lr
...
sub_80A6F3C:
    ...
    add r4, r4, r0
    strb r4, [r3]
    ldrb r4, [r3,#(byte_2000891 - 0x2000890)]
    add r4, r4, r1
    strb r4, [r3,#(byte_2000891 - 0x2000890)]
    ldrb r4, [r3,#(byte_2000892 - 0x2000890)]
    add r4, r4, r2
    strb r4, [r3,#(byte_2000892 - 0x2000890)]
    pop {r4,pc}
...
loc_80A6F56:
    ...
    strh r0, [r3,#(word_2000896 - 0x2000890)]
    mov pc, lr
...
sub_80A6F5C:
    ...
    strb r0, [r3,#(byte_2000893 - 0x2000890)]
    mov pc, lr
...
sub_80A6F64:
    ...
    ldrb r0, [r3,#(byte_2000893 - 0x2000890)]
    mov pc, lr
...
sub_80A6F6A:
    ...
    strb r0, [r1,#(byte_2000894 - 0x2000890)]
    mov r0, #8
    strb r0, [r3,#3]
    mov pc, lr
...
sub_80A907C:
    ...
    mov r1, #0
    strb r1, [r0]
    str r1, [r0,#(dword_20093F4 - 0x20093f0)]
locret_80A9090:
    pop {pc}
    .balign 4, 0x00
...
loc_80A9120:
    ...
    str r0, [r7,#(dword_20093F4 - 0x20093f0)]
    pop {r4-r7,pc}
locret_80A912E:
    pop {r4-r7,pc}
...
sub_80A9130:
    ...
    ldr r7, [r7,#(dword_20093F4 - 0x20093f0)]
    mov pc, lr  // <endpool>
